...
export function Footer() {
  ...
  if (recipe.footer === 'dense-footer') {
    return (
      <footer className="border-t border-white/10 bg-[linear-gradient(180deg,#2C687B_0%,#245a68_100%)] text-white">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr_1fr]">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7">
              ...
              {primaryTask ? (
                <Link href={primaryTask.route} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#DB1A1A] px-4 py-2.5 text-sm font-semibold text-[#FFF6F6] hover:bg-[#c41515]">
  ...
  return (
    <footer className="border-t border-white/10 bg-[#2C687B] text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_0.8fr]">
          <div>
            <Link href="/" className="flex items-center gap-3">
              <div className="h-11 w-11 overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-1">
            ...
            {primaryTask ? (
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#DB1A1A] px-4 py-2.5 text-sm font-semibold text-[#FFF6F6] hover:bg-[#c41515]"
              >
                Explore {primaryTask.label}
                <ArrowRight className="h-4 w-4" />
              </Link>
